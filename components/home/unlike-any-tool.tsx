...
import { Button, Highlight } from "../global/button";
import { CommandMenu } from "../global/command-menu";
import { Container } from "../global/container";
import { LogoLightIllustration } from "../global/illustrations/logo-light";
import { ZapIllustration } from "../global/illustrations/zap";
import { KeyboardShortcuts } from "../global/keyboard-shortcuts";

export const UnlikeAnyTool = () => (
  <Section>
    <div className="text-white px-[12rem] mt-[12rem]">
      <Container>
      ...
      {/* <div className="h-[48rem] overflow-hidden md:h-auto md:overflow-auto">
        <div className="snap-x snap-mandatory gap-6 px-8 pb-12 md:overflow-hidden">
          <div className="flex min-h-[48rem] w-full shrink-0 snap-center flex-col items-center justify-end overflow-hidden rounded-[4.8rem] border border-transparent-white bg-glass-gradient p-8 text-center md:max-w-[calc(66.66%-12px)] md:basis-[calc(66.66%-12px)] md:p-14">
            <KeyboardShortcuts />
