...
export const HeroImage = () => {
  ...
  }, [inView, setLines, isVisible]);

  return (
    // <Section>
      <div id="hero-image" ref={ref} className="px-[1rem]  mb-[16rem] pt-[8rem] md:mb-0 md:pt-0 md:mt-[6rem] md:px-[4rem] [perspective:2000px] w-screen">
        ...
        <div
          className={classNames(
            "relative rounded-lg border border-transparent-white bg-white bg-opacity-[0.01] bg-hero-gradient md:mx-[6rem]",
