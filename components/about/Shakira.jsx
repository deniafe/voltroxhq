...
Command: npx gltfjsx@6.2.5 public/models/shakira.glb --k
*/
...
export function Shakira(props) {
  ...
  const { nodes, materials } = useGLTF('./models/shakira.glb')
  ...
  const {animations: walkingAnimation} = useFBX('./animations/WalkingShakira.fbx')
...
useGLTF.preload('./models/shakira.glb')
