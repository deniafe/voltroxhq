...
export const Form = () => {
  return (
      <div id="contact-section" className="flex pt-navigation-height w-screen md:pt-0 flex-col mb-[6rem] md:flex-row md:justify-center items-center w-screen">
       <div id="one" className="text-white text-center flex flex-col justify-center w-full items-center flex-1">
        ...
        <div className="hidden md:flex flex-col flex-1 mt-12 md:mt-0 md:ml-0 w-screen h-screen md:w-auto">
          <Canvas>
            <ambientLight intensity={1} />
            <Shakira animation={'Walking'}/>
             {/* <Shakira/> */}
          </Canvas>
        </div>
      </div>
